            ...
            while (($data = fgetcsv($handle, 100000, ',')) !== false) {
                try {
                    ...
                    $tower_data = array(
                        ...
                        'Display_secretary_e_mail' => sanitize_text_field($data[24]),
                        'Expose_secretary_e_mail' => sanitize_text_field($data[25]),
                        ...
                        'Display_deputy_secretary' => sanitize_text_field($data[105]),
                        'Deputy_secretary_address' => $data[106],
                        'Display_deputy_secretary_address' => sanitize_text_field($data[107]),
                        'Deputy_secretary_telephone' => $data[108],
                        'Display_deputy_secretary_telephone' => sanitize_text_field($data[109]),
                        'Deputy_secretary_mobile' => $data[110],
                        'Display_deputy_secretary_mobile' => sanitize_text_field($data[111]),
                        'Display_deputy_secretary_e_mail' => sanitize_text_field($data[112]),
                        'Expose_deputy_secretary_e_mail' => sanitize_text_field($data[113]),
                        'Deputy_secretary_e_mail' => $data[114],
                        'Deputy_secretary_comments' => $data[115],
                        'Ringing_master_telephone' => $data[116],
                        'Display_ringing_master_telephone' => sanitize_text_field($data[117]),
                        'Ringing_master_e_mail' => $data[118],
                        'Display_ringing_master_e_mail' => sanitize_text_field($data[119]),
                        'Expose_ringing_master_e_mail' => sanitize_text_field($data[120]),
                        'Practice_night_phone_to_confirm' => $data[121],
                        'Practice_night_comments' => $data[122],
                        'Tower_captain_telephone' => $data[123],
                        'Display_tower_captain_telephone' => sanitize_text_field($data[124]),
                        'Tower_captain_e_mail' => $data[125],
                        'Display_tower_captain_e_mail' => sanitize_text_field($data[126]),
                        'Expose_tower_captain_e_mail' => sanitize_text_field($data[127]),
