            ...
            while (($data = fgetcsv($handle, 100000, ',')) !== false) {
                try {
                    ...
                    $tower_data = array(
                        ...
                        'Secretary_address_Address_line_5' => $data[19],
                        'Display_secretary_address' => $data[20],
                        'Secretary_telephone' => $data[21],
                        'Display_secretary_telephone' => $data[22],
                        'Secretary_mobile' => $data[23],
                        'Display_secretary_mobile' => $data[24],
                        'Display_secretary_e_mail' => $data[25],
                        'Expose_secretary_e_mail' => $data[26],
                        'Secretary_e_mail_0' => $data[27],
                        'Secretary_e_mail_1' => $data[28],
                        'Secretary_comments' => $data[29],
                        'OS_reference' => $data[30],
                        'What3WordsDoorLoc_0' => $data[31],
                        'What3WordsDoorLoc_1' => $data[32],
                        'Number_of_bells' => intval($data[33]),
                        'Comment_1' => $data[34],
                        'Comment_1_link' => $data[35],
                        'Comment_1_italics' => $data[36],
                        'Comment_2' => $data[37],
                        'Comment_2_link' => $data[38],
                        'Comment_2_italics' => $data[39],
                        'Bell_comment' => $data[40],
                        'Bell_comment_link' => $data[41],
                        'Bell_comment_italics' => $data[42],
                        'Postcode' => $data[43],
                        'Felstead_ID' => $data[44],
                        'RW_Peal_ID' => $data[45],
                        'Bellboard_place' => $data[46],
                        'Bellboard_dedication' => $data[47],
                        'Bellboard_county' => $data[48],
                        'DoveID' => $data[49],
                        'Map_X' => $data[50],
                        'Map_Y' => $data[51],
                        'Ground_floor' => $data[52],
                        'Toilet' => $data[53],
                        'Bells_Bell_0_Number' => $data[54],
                        'Bells_Bell_0_Date' => $data[55],
                        'Bells_Bell_0_Weight' => $data[56],
                    'Bells_Bell_0_Note' => $data[57],
                    'Bells_Bell_1_Number' => $data[58],
                    'Bells_Bell_1_Date' => $data[59],
                    'Bells_Bell_1_Weight' => $data[60],
                    'Bells_Bell_1_Note' => $data[61],
                    'Bells_Bell_2_Number' => $data[62],
                    'Bells_Bell_2_Date' => $data[63],
                    'Bells_Bell_2_Weight' => $data[64],
                    'Bells_Bell_2_Note' => $data[65],
                    'Bells_Bell_3_Number' => $data[66],
                    'Bells_Bell_3_Date' => $data[67],
                    'Bells_Bell_3_Weight' => $data[68],
                    'Bells_Bell_3_Note' => $data[69],
                    'Bells_Bell_4_Number' => $data[70],
                    'Bells_Bell_4_Date' => $data[71],
                    'Bells_Bell_4_Weight' => $data[72],
                    'Bells_Bell_4_Note' => $data[73],
                    'Bells_Bell_5_Number' => $data[74],
                    'Bells_Bell_5_Date' => $data[75],
                    'Bells_Bell_5_Weight' => $data[76],
                    'Bells_Bell_5_Note' => $data[77],
                    'Bells_Bell_6_Number' => $data[78],
                    'Bells_Bell_6_Date' => $data[79],
                    'Bells_Bell_6_Weight' => $data[80],
                    'Bells_Bell_6_Note' => $data[81],
                    'Bells_Bell_7_Number' => $data[82],
                    'Bells_Bell_7_Date' => $data[83],
                    'Bells_Bell_7_Weight' => $data[84],
                    'Bells_Bell_7_Note' => $data[85],
                    'Tower_captain_telephone' => $data[86],
                    'Display_tower_captain_telephone' => $data[87],
                    'Tower_captain_e_mail' => $data[88],
                    'Display_tower_captain_e_mail' => $data[89],
                    'Expose_tower_captain_e_mail' => $data[90],
                    'Bells_Bell_8_Number' => $data[91],
                    'Bells_Bell_8_Date' => $data[92],
                    'Bells_Bell_8_Weight' => $data[93],
                    'Bells_Bell_8_Note' => $data[94],
                    'Bells_Bell_9_Number' => $data[95],
                    'Bells_Bell_9_Date' => $data[96],
                    'Bells_Bell_9_Weight' => $data[97],
                    'Bells_Bell_9_Note' => $data[98],
                    'Bells_Bell_10_Number' => $data[99],
                    'Bells_Bell_10_Date' => $data[100],
                    'Bells_Bell_10_Weight' => $data[101],
                    'Bells_Bell_10_Note' => $data[102],
                    'Bells_Bell_11_Number' => $data[103],
                    'Bells_Bell_11_Date' => $data[104],
                    'Bells_Bell_11_Weight' => $data[105],
                    'Bells_Bell_11_Note' => $data[106],
                    'Bells_Bell_12_Number' => $data[107],
                    'Bells_Bell_12_Date' => $data[108],
                    'Bells_Bell_12_Weight' => $data[109],
                    'Bells_Bell_12_Note' => $data[110],
                    'Include_dedication' => $data[111],
                    'Deputy_secretary' => $data[112],
                    'Display_deputy_secretary' => $data[113],
                    'Deputy_secretary_address' => $data[114],
                    'Display_deputy_secretary_address' => $data[115],
                    'Deputy_secretary_telephone' => $data[116],
                    'Display_deputy_secretary_telephone' => $data[117],
                    'Deputy_secretary_mobile' => $data[118],
                    'Display_deputy_secretary_mobile' => $data[119],
                    'Display_deputy_secretary_e_mail' => $data[120],
                    'Expose_deputy_secretary_e_mail' => $data[121],
                    'Deputy_secretary_e_mail' => $data[122],
                    'Deputy_secretary_comments' => $data[123],
                    'Ringing_master_telephone' => $data[124],
                    'Display_ringing_master_telephone' => $data[125],
                    'Ringing_master_e_mail' => $data[126],
                    'Display_ringing_master_e_mail' => $data[127],
                    'Expose_ringing_master_e_mail' => $data[128],
                    'Practice_night_phone_to_confirm' => $data[129],
                    'Practice_night_comments' => $data[130],
